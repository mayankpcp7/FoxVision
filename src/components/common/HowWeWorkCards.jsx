const HowWeWorkCards = (props) => {
  return (
    <div
      className={`${props.className} sm:pt-[26.83px] lg:max-w-[366px] w-full h-full sm:px-[26.81px] sm:pb-[43.91px] rounded-[6px] p-6 hover:shadow-[1px_8px_20px_#07183826] transition-all ease-linear duration-300`}
    >
      <div
