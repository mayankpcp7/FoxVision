...
const AngebotCardsList = (props) => {
  return (
    <div
      className={`${props.className} pt-[26.83px] px-[26.81px] pb-[35.24px] bg-white rounded-[6px] lg:max-w-[366px] w-full h-full xl:min-h-[383px] flex justify-between flex-col relative hover:shadow-[0_0_11px_rgba(255,255,255,1)] transition-all ease-linear duration-300 group`}
    >
      <div>
        <div
          className={`${
      ...
      <Link
        className={`${
          props.cardLink ? "bottom-12" : ""
        } text-darkpurple absolute bottom-14 flex items-center gap-[10px] opacity-70 font-poppins font-normal sm:text-base text-sm`}
        href="/"
      >
        {props.cardBtn}
        {props.arrow}
